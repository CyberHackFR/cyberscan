...
// Since Rust no longer uses jemalloc by default, cyberscan will, by default,
// use the system allocator. On Linux, this would normally be glibc's
// allocator, which is pretty good. In particular, cyberscan does not have a
// particularly allocation heavy workload, so there really isn't much
// difference (for cyberscan's purposes) between glibc's allocator and jemalloc.
//
// However, when cyberscan is built with musl, this means cyberscan will use musl's
